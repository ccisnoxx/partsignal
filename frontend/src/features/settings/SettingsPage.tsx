...
export function SettingsPage() {
  return <div className="page-stack"><header className="page-heading"><div><Typography.Text className="eyebrow">WORKSPACE</Typography.Text><Typography.Title>业务设置</Typography.Title><Typography.Paragraph>维护目标问题和公开平台账号标识；用户与 AI 配置由管理员在独立入口管理。</Typography.Paragraph></div></header>
    <Tabs items={[
