...
const navigation: Array<{ key: string; icon: ReactNode; label: string; adminOnly?: boolean }> = [
...
export function AppLayout() {
  ...
  const auth = useAuth();
  const visibleNavigation = navigation.filter((item) => !item.adminOnly || auth.isAdmin);
