  ...
  content_rankings: {
    ...
    declining: [{
      ...
      optimization_action: {
        ...
        date_to: '2026-07-21',
        published_article_id: decliningPublicationId,
        query_topic_id: null,
        geo_platform: null,
      },
    ...
    matrix: [
      ...
      },
      {
        ...
        optimization_action: {
          ...
          date_from: '2026-07-20', date_to: '2026-07-21', published_article_id: null,
          query_topic_id: secondTopicId, geo_platform: 'DeepSeek',
        },
      },
      {
        ...
        optimization_action: {
          rule_code: 'QUESTION_COVERAGE_GAP',
          date_from: '2026-07-20', date_to: '2026-07-21', published_article_id: null,
          query_topic_id: thirdTopicId, geo_platform: 'Gemini',
        },
      },
      {
