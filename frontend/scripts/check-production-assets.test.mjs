...
const expectedIndex = `<!doctype html><html><head><meta name="robots" content="index,follow"><meta name="description" content="PartSignal 是面向已授权用户的多平台 GEO 内容运营系统，提供内容运营、发布与效果观测入口。"></head></html>`;
