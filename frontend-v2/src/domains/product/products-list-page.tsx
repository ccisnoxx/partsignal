...
import { deleteProduct, productsKeys, productsListQueryOptions } from './products-list.api';
import {
  formatCurrentFact,
    ...
    columnHelper.display({
      ...
      cell: ({ row }) => (
        <RowActions
          ...
          overflow={resolveProductOverflowActions(row.original, deletingProductId === row.original.id)}
